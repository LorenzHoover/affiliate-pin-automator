  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-6">
      <div className="bg-white p-6 rounded-2xl shadow-lg max-w-2xl text-left">
        ...
        <h2 className="text-xl font-semibold text-gray-800 mt-4">Interpretation and Definitions</h2>
        ...
        <ul className="list-disc pl-5 text-gray-600">
          ...
          <li><strong>Company</strong>: Affilipin.io.</li>
          <li><strong>Country</strong>: North Carolina, United States.</li>
          <li><strong>Service</strong>: Refers to the Application.</li>
          <li><strong>Personal Data</strong>: Any information that relates to an identified or identifiable individual.</li>
          <li><strong>Usage Data</strong>: Data collected automatically (e.g., IP address, browser type, time spent on a page).</li>
        </ul>
        <h2 className="text-xl font-semibold text-gray-800 mt-4">Collecting and Using Your Personal Data</h2>
        <h3 className="text-lg font-semibold text-gray-700 mt-3">Types of Data Collected</h3>
        <p className="text-gray-600">We may collect the following types of personal data:</p>
        <ul className="list-disc pl-5 text-gray-600">
          <li>Email address</li>
          <li>Usage Data</li>
        </ul>
        <h3 className="text-lg font-semibold text-gray-700 mt-3">Use of Your Personal Data</h3>
        <p className="text-gray-600">
        ...
        <h2 className="text-xl font-semibold text-gray-800 mt-4">Security of Your Personal Data</h2>
        <p className="text-gray-600">
